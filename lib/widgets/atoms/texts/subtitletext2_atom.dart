...
class SubtitleText2 extends StatelessWidget {
  ...
  SubtitleText2(this.text, {Key key, this.style, this.color, this.align, this.selectable = false}) : super(key: key);
  ...
  Widget build(BuildContext context) => selectable ? SelectableText(
    ...
    style: style?.copyWith(
        ...
        letterSpacing: Utils.setPoint(0.1),
